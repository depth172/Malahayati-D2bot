...
tweet.write("今日は土曜日です。シュールが “" + locationText + "” にて出没していることが確認されています。\n\n")
...
for c in range(3):
    ...
    tweet.write(classDict[c] + "アーマー: " + eArmorName + "\n")
